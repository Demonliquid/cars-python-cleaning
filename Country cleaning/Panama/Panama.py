...
# %% CARGA DE DATOS
panama = pd.read_csv(r"D:\Basededatos\Origen\Panama\Panama 2000\CSV\panama.csv")
...
listamarca = r'''(vikino|LEXUS|MAZDA|TOYOTA|HYUNDAI|HERO|yamaha|suzuki|kawasaki|SUZUKI|Suzuki|BISEK|YAMAHA|JOHN DEERE|PRATO FORNE|KAWWASAKI|HENGNIU|FREIGHT LINER|FORD|HONDA|KAWASAKI|vikyno|AVA)'''
...
listamodelo = r'''(ELANTRA|4RUNNER|4-RUNNER|GX460|RANGE ROVER|DISCOVERY|HI-LUX|HI LUX|LAND CRUISER|FORTUNER|YARIS|RAV 4|COROLLA|TUCSON|RAV4|ACCENT|HILUX)'''
...
# %%
panama.to_csv(r'D:\Basededatos\Limpioparaentregar\panama\panama.csv', index=False)
