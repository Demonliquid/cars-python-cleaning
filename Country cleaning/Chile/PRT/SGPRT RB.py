...
# %% CARGA DE DATOS
path = r'F:\Trabajo\Promotive\Chile\PRT\6\Listo\9'
os.chdir(path)
...
# %%
for f in files_xls:
    data = pd.read_csv(f, delimiter=";", error_bad_lines=False, encoding="latin-1")
...
# %%
chile.to_csv(r'F:\Trabajo\Promotive\Chile\PRT\Limpio\SGPRT RB9.csv')
