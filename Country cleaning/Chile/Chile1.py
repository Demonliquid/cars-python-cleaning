...
# %% ARREGLAR MODELO
condicion = (chile1["MODELO"] == "PICK") | (chile1["MODELO"] == "PICKUP")
chile1.loc[condicion, "SEGMENTO.1"] = "PICK UP"
chile1.loc[condicion, "MODELO"] = None


# KIA
listamodelo = r'''(SORENTO)'''
chile1["MODELO2"] = chile1["MODELO / VERSION"].str.extract(listamodelo, expand=False).str.strip()
condicion = chile1["MODELO2"].notna()
chile1.loc[condicion, "MODELO"] = chile1.loc[condicion, "MODELO2"]
chile1 = chile1[["PATENTE", "SEGMENTO.1", "MARCA", "MODELO / VERSION", "AÑO", "RUT", "NUMERO MOTOR", "MERCADO", "CANTIDAD", "MOTOR", "MODELO"]]
...
chile1.loc[condicion, "MODELO"] = chile1.loc[condicion, "MODELO2"]
chile1 = chile1[["PATENTE", "SEGMENTO.1", "MARCA", "MODELO / VERSION", "AÑO", "RUT", "NUMERO MOTOR", "MERCADO", "CANTIDAD", "MOTOR", "MODELO"]]
chile1["MODELO"].replace({"TL - 12":"Renault 12"}, inplace=True)
...
chile1.loc[condicion, "MODELO"] = chile1.loc[condicion, "MODELO2"]
chile1 = chile1[["PATENTE", "SEGMENTO.1", "MARCA", "MODELO / VERSION", "AÑO", "RUT", "NUMERO MOTOR", "MERCADO", "CANTIDAD", "MOTOR", "MODELO"]]
chile1["MODELO"].replace({"SPACIO":"SPAZIO"}, inplace=True)
...
chile1["MODELO"].replace({"VITZ": "YARIS",
                            "IST": "URBAN CRUISER",
...
chile1["MODELO"].replace({"V16 SENTRA": "SENTRA"}, inplace=True)
...
chile1["MODELO"].replace({"PREMIO": "DUNA"}, inplace=True)
...
chile1["MODELO"].replace({"SUNNY": "SENTRA"}, inplace=True)


# MITSUBISHI
chile1["MODELO"].replace({"PAJERO": "MONTERO"}, inplace=True)
...
chile1.loc[condicion, "MODELO"] = chile1.loc[condicion, "MODELO2"]
chile1 = chile1[["PATENTE", "SEGMENTO.1", "MARCA", "MODELO / VERSION", "AÑO", "RUT", "NUMERO MOTOR", "MERCADO", "CANTIDAD", "MOTOR", "MODELO"]]
chile1["MODELO"].replace({"3": None}, inplace=True)
...
# %%
dict(chile1["MODELO"].value_counts())


# %%
condicion = chile1["MODELO"] == "XL"
chile1[condicion]


# %%
dict(chile1[condicion]["MODELO / VERSION"].value_counts())
