...
# %% CARGA DE DATOS
# UBICACION
path = r'D:\Basededatos\Origen\Peru\2016-2021'
os.chdir(path)
...
# %%
peru.to_csv(r"D:\Basededatos\Limpioparaentregar\peru\peru16-21original.csv", index=False)
...
# %%
peru.to_csv(r"D:\Basededatos\Limpioparaunir\peru16-21.csv", index=False)
