...
# %% CARGA DE DATOS
# UBICACION
path = r'D:\Basededatos\Origen\Peru\2008-2011'
os.chdir(path)
...
# %%
peru.to_csv(r"D:\Basededatos\Limpioparaentregar\peru\peru08-11original.csv", index=False)
...
# %%
peru.to_csv(r"D:\Basededatos\Limpioparaunir\peru08-11.csv", index=False)
